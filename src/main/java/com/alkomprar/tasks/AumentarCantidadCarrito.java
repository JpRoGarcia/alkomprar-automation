...
import static com.alkomprar.userinterfaces.CarritoPage.CANTIDAD_ARTICULO_CARRITO;
import static com.alkomprar.userinterfaces.CarritoPage.ELIMINAR_ARTICULO_CARRITO;
...
public class AumentarCantidadCarrito implements Task {
    private String item;

    public AumentarCantidadCarrito(String item) {
        this.item = item;
    }

    public static Performable elemento(String item) {
        return instrumented(com.alkomprar.tasks.AumentarCantidadCarrito.class, item);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(CARRITO),
                Click.on(CANTIDAD_ARTICULO_CARRITO)
        );
    }
}
